...
learningCmd
  ...
  .option(
    "--type <type>",
    "Session type (regular, assessment, review)",
    "regular",
  )
...
learningCmd
  ...
  .option(
    "--type <type>",
    "Content type (lesson, exercise, assignment, quiz)",
    "lesson",
  )
  .option(
    "--difficulty <difficulty>",
    "Difficulty level (basic, moderate, challenging)",
  )
  .action(async (options) => {
...
evalCmd
  ...
  .option(
    "--type <type>",
    "Evaluation type (all, hallucination, factuality, quality)",
    "all",
  )
...
evalCmd
  ...
  .option(
    "--type <type>",
    "Dashboard type (infrastructure, quality, business, comprehensive)",
    "comprehensive",
  )
...
systemCmd
  ...
  .option(
    "--stack <stack>",
    "Specific stack to deploy (all, main, evaluation, monitoring)",
    "all",
  )
